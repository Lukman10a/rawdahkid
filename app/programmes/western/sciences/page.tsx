  ...
  return (
    <div className="flex flex-col min-h-screen bg-ivory dark:bg-midnight text-midnight dark:text-cream pt-24">
      ...
      <section className="relative py-20 overflow-hidden border-b border-midnight/10 dark:border-white/10">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-emerald-500/5 dark:bg-emerald-400/5 rounded-full blur-[100px] pointer-events-none z-0"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4 text-midnight/80 dark:text-muted font-sans leading-relaxed text-lg">
              ...
              <p className="font-semibold text-midnight dark:text-cream italic border-l-4 border-emerald-600 dark:border-emerald-400 pl-4 py-1">
