...
export default function EnrolPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-cream text-midnight pt-24">
      {/* HEADER */}
      <section className="py-20 bg-ivory dark:bg-midnight text-midnight dark:text-cream border-b border-gold/10">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              >
                <div className="w-16 h-16 bg-white dark:bg-navy text-gold mx-auto rounded-full flex items-center justify-center mb-6 border-4 border-white shadow-md">
                ...
                <p className="font-sans text-midnight/70 dark:text-muted text-sm leading-relaxed">
                  {s.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-10 md:p-14 shadow-2xl rounded-sm border-t-4 border-t-gold">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full bg-ivory dark:bg-midnight text-midnight dark:text-cream py-4 font-sans tracking-widest uppercase text-sm hover:bg-gold hover:text-midnight transition-colors duration-300">
