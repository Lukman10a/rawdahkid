    ...
    <>
      <nav
        className={cn(
          ...
          isScrolled
            ? "bg-midnight/90 backdrop-blur-md border-white/5 py-4 shadow-sm"
            : "bg-transparent py-6",
        )}
      >
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="flex flex-col">
                ...
                <span className="font-cinzel text-cream text-sm tracking-[0.2em] group-hover:text-white transition-colors">
                  RAWDATUL ATFAAL
                </span>
              </div>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link
                href="/"
                className="text-cream/80 hover:text-gold transition-colors text-sm uppercase tracking-wider relative group"
              >
                Home
              ...
              >
                <div className="flex items-center space-x-1 text-cream/80 hover:text-gold transition-colors text-sm uppercase tracking-wider py-2">
                ...
                <div
                  className={cn(
                    "absolute top-full left-0 w-56 bg-navy border border-white/5 shadow-xl rounded-sm py-2 transition-all duration-200 origin-top-left",
                    isProgrammesOpen
      ...
      <div
        className={cn(
          "fixed inset-0 z-60 bg-midnight flex flex-col transition-transform duration-500 ease-in-out md:hidden",
      ...
      >
        <div className="flex justify-between items-center p-6 border-b border-white/5">
          <div className="flex flex-col">
            ...
            <span className="font-cinzel text-cream text-sm tracking-[0.2em]">
              RAWDATUL ATFAAL
            </span>
          </div>
          <button
        ...
        <div className="flex-1 flex flex-col justify-center items-center space-y-8 p-6">
          <Link
            href="/"
            onClick={() => setIsMobileMenuOpen(false)}
            className="text-3xl font-cinzel text-cream hover:text-gold transition-colors"
          >
            Home
          </Link>
          <Link
          ...
          <Link
            href="/programmes/islamic"
            onClick={() => setIsMobileMenuOpen(false)}
            className="text-3xl font-cinzel text-cream hover:text-gold transition-colors text-center"
          >
            Islamic
            <br />
            <span className="text-lg text-cream/50">Programme</span>
          </Link>
          <Link
            href="/programmes/western"
            onClick={() => setIsMobileMenuOpen(false)}
