...
function LevelCard({
  ...
  const t = useTranslations("ProgHistory");
  ...
  return (
    ...
    >
      <div className="bg-midnight dark:bg-navy p-8 md:p-10 border-b border-amber-600/30">
        <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="text-amber-400 dark:text-amber-300 font-cinzel font-bold tracking-widest text-sm mb-2 uppercase">
          ...
          <div className="md:text-end">
            <div className="inline-flex items-center justify-center p-3 rounded-full bg-white/10 dark:bg-black/20 text-amber-400">
      ...
      <div className="p-0 bg-white dark:bg-transparent">
        <div className="w-full overflow-x-auto">
          <table className="w-full text-start border-collapse min-w-200">
            <thead>
              <tr className="border-b-2 border-amber-100 dark:border-white/10 bg-amber-50/50 dark:bg-white/5">
                <th className="py-4 px-6 font-cinzel text-amber-700 dark:text-amber-400 font-bold w-16 text-center">
                  {t("t29")}
                </th>
            ...
            <tbody className="font-sans text-midnight/80 dark:text-cream/80 text-sm">
              {units.map((unit, idx) => (
                ...
                >
                  <td className="py-4 px-6 font-bold text-center text-amber-600 dark:text-amber-400">
                    {unit.no}
                  </td>
  ...
  return (
    <section className="w-full min-w-0 py-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-20">
        ...
        <div className="w-24 h-px bg-amber-600/50 dark:bg-amber-400/50 mx-auto"></div>
      </div>
