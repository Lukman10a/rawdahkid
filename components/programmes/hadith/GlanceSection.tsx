...
export default function GlanceSection() {
  ...
  const rows = [
    { level: t("t16"), duration: t("t17"), summary: t("t18") },
    { level: t("t19"), duration: t("t20"), summary: t("t21") },
    { level: t("t22"), duration: t("t23"), summary: t("t24") },
    { level: t("t25"), duration: t("t9"), summary: t("t27") },
  ];
