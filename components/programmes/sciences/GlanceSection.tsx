...
export default function GlanceSection() {
  ...
  const rows = [
    { lvl: "1", age: "6-7", focus: t("t60") },
    { lvl: "2", age: "7-8", focus: t("t58") },
    { lvl: "3", age: "8-9", focus: t("t64") },
    { lvl: "4", age: "9-10", focus: t("t62") },
    { lvl: "5", age: "10-11", focus: t("t65") },
    { lvl: "6", age: "11-12", focus: t("t59") },
    { lvl: "7", age: "12-13", focus: t("t57") },
    { lvl: "8", age: "13-14", focus: t("t63") },
    { lvl: "9", age: "14-15", focus: t("t35") },
    { lvl: "10", age: "15-16", focus: t("t61") },
  ];

  return (
    <section className="w-full min-w-0 py-20 bg-emerald-50/50 dark:bg-emerald-900/10 border-y border-midnight/5 dark:border-white/5">
