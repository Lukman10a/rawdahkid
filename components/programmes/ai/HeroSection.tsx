...
export default function HeroSection() {
  ...
  return (
    <section className="w-full min-w-0 relative py-20 overflow-hidden border-b border-midnight/10 dark:border-white/10">
      ...
      <div className="absolute top-1/2 inset-s-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-cyan-500/5 dark:bg-cyan-400/5 rounded-full blur-[100px] pointer-events-none z-0"></div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          <div className="inline-flex items-center justify-center p-3 bg-cyan-500/10 dark:bg-cyan-400/10 rounded-full mb-6">
          ...
          <h2 className="font-sans text-xl md:text-2xl text-cyan-600 dark:text-cyan-400 uppercase tracking-widest mb-6 font-semibold">
            {t("t1")}
          </h2>
