...
function LevelCard({
  ...
  return (
    ...
    >
      <div className="bg-midnight dark:bg-navy p-8 md:p-10 border-b border-cyan-600/30">
        <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="text-cyan-400 dark:text-cyan-400 font-cinzel font-bold tracking-widest text-sm mb-2 uppercase">
          ...
          <div className="md:text-end">
            <div className="inline-flex items-center justify-center p-3 rounded-full bg-white/10 dark:bg-black/20 text-cyan-400">
      ...
      <div className="p-0 bg-white dark:bg-transparent">
        <div className="w-full overflow-x-auto">
          <table className="w-full text-start border-collapse min-w-200">
            <thead>
              <tr className="border-b-2 border-cyan-100 dark:border-white/10 bg-cyan-50/50 dark:bg-white/5">
                <th className="py-4 px-6 font-cinzel text-cyan-700 dark:text-cyan-400 font-bold w-16 text-center">
                  {t("t29")}
                </th>
            ...
            <tbody className="font-sans text-midnight/80 dark:text-cream/80 text-sm">
              {units.map((unit, idx) => (
                ...
                >
                  <td className="py-4 px-6 font-bold text-center text-cyan-600 dark:text-cyan-400">
                    {unit.no}
                  </td>
