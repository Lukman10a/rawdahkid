  ...
  return (
    <section className="w-full min-w-0 py-24 bg-white dark:bg-navy border-t border-midnight/10 dark:border-white/10">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <GraduationCap className="w-16 h-16 text-cyan-600 dark:text-cyan-400 mx-auto mb-6" />
        ...
        <div className="bg-ivory dark:bg-midnight p-8 md:p-12 border border-cyan-600/30 dark:border-cyan-400/30 rounded-sm inline-block w-full max-w-md shadow-xl">
          <h3 className="font-playfair text-2xl text-midnight dark:text-cream mb-2">
            {t("t20")}
          </h3>
          <div className="font-cormorant text-5xl text-cyan-600 dark:text-cyan-400 mb-6">
            {t("t21")}
          </div>
        ...
        <div className="mt-8">
          <Link
            ...
            className="text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 transition-colors font-sans underline underline-offset-4"
          >
            {t("t26")}
          </Link>
        </div>
